...
public class Evento {
    ...
    public int getIngressosDisponiveis() {
        return local.getCapacidade() - ingressosVendidos;
    }
    ...
    public static Evento criarEvento(int id, String nome, Data data, String descricao, float valor, Local local) {

        return new Evento(id, nome, data, descricao, valor, 0, local);
    }
